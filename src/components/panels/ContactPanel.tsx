...
export default function ContactPanel({ onClose }: PanelProps) {
  const items = [
    {
      // @ts-ignore
      icon: <lord-icon src="/icons/gtvaxhwv.json" trigger="hover" stroke="bold" colors="primary:#ffffff,secondary:#00c8ff,tertiary:#7c3aed,quaternary:#e2e8f0" style={{width: '90px', height: '90px'}}></lord-icon>,
      title: "Email",
    ...
    {
      // @ts-ignore
      icon: <lord-icon src="/icons/xerxcacw.json" trigger="hover" stroke="bold" state="morph-alone" colors="primary:#ffffff,secondary:#00c8ff" style={{width: '90px', height: '90px'}}></lord-icon>,
      title: "LinkedIn",
    ...
    {
      // @ts-ignore
      icon: <lord-icon src="/icons/lllcnxva.json" trigger="hover" stroke="bold" colors="primary:#ffffff,secondary:#00c8ff,tertiary:#7c3aed" style={{width: '90px', height: '90px'}}></lord-icon>,
      title: "GitHub",
